...
To solve these problems, `lockbox` provides Rust bindings to the [age encryption tool](https://age-encryption.org) and a convenience wrapper around the [SOPS secrets manager.](https://getsops.io/)
